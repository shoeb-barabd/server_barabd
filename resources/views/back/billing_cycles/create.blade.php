@extends('layouts.app')
@section('title','New Billing Cycle')
@section('page_title','New Billing Cycle')
@section('breadcrumb','Billing Cycles / New')
...
<div class="card card-primary card-outline">
  <div class="card-header">
    <h5 class="m-0">Create Billing Cycle</h5>
  </div>
  <div class="card-body">
    <form method="post" action="{{ route('admin.billing-cycles.store') }}">
      @csrf
